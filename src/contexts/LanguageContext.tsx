...
const ES = {
  ...
  "page.lab1_link":
    "Laboratorio 1 — Fuerzas entre corrientes y campos magnéticos →",
  "page.lab2_link": "Laboratorio 2 — Medición de la permeabilidad del vacío →",
  "page.description":
  ...
  "preset.concentric": "Cable concéntrico",
  ...
  "preset3d.concentric": "Cable concéntrico (3D)",
...
const EN: Record<TranslationKey, string> = {
  ...
  "page.lab2_link": "Lab 2 — Measuring the permeability of free space →",
  "page.description":
  ...
  "preset.concentric": "Concentric cable",
  ...
  "preset3d.concentric": "Concentric cable (3D)",
